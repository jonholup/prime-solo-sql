...
SET "account_balance" = '10.00' WHERE "user_id" = '5';
...
-- 7. Get all users with account balances that are more than $100. ("username" could've been '*' to grab all info)
...
VALUES ('jonny', 'minneapolis', 4, 11, 5.40);
...
SELECT * FROM "syntax_practice"
WHERE ("city" LIKE 'phoenix' OR "city" LIKE 'miami')
